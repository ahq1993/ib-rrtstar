...
namespace SingleIntegrator {
    ...
    public:    
        ...
        State& getRootState2 () {return rootState2;}
         ...
         * A more elaborate description.
         */
        bool isReachingTarget (State &stateIn,int a);
         ...
         *
         */
        double evaluateCostToGo (State& stateIn,int a);
